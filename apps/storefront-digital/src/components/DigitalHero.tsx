  ...
  return (
    <div className="flex flex-col bg-[#020617]">
      <section className="relative isolate overflow-hidden text-white">
        <div className="absolute inset-0">
          ...
          <Image
            ...
            priority
            sizes="100vw"
            className="object-cover object-[66%_40%] lg:hidden"
          />
        </div>

        <div
          aria-hidden="true"
          className="absolute inset-0 bg-[linear-gradient(180deg,rgba(2,6,23,0.32)_0%,rgba(2,6,23,0.42)_28%,rgba(2,6,23,0.76)_56%,rgba(2,6,23,1)_100%)] lg:bg-[linear-gradient(90deg,rgba(2,6,23,0.98)_0%,rgba(2,6,23,0.94)_24%,rgba(2,6,23,0.72)_40%,rgba(2,6,23,0.3)_56%,rgba(2,6,23,0.08)_70%,rgba(2,6,23,0.02)_100%)]"
        />
        <div
          aria-hidden="true"
        ...
        <div className="relative z-10 mx-auto flex min-h-[500px] max-w-[1920px] flex-col justify-center px-5 pb-12 pt-12 sm:px-6 lg:h-[550px] lg:min-h-[550px] lg:px-10 lg:pt-5 xl:px-12">
          <div className="grid gap-3 lg:grid-cols-[minmax(0,800px)_1fr] lg:items-center">
            <div className="max-w-[800px] pt-3 lg:pt-0">
              <span className="inline-flex items-center gap-2 rounded-full border border-[rgba(34,197,94,0.46)] bg-[rgba(7,33,20,0.72)] px-3.5 py-1.5 text-[0.64rem] font-black uppercase tracking-[0.08em] text-[#1fff57] shadow-[0_0_0_1px_rgba(34,197,94,0.1)] lg:text-[0.7rem]">
                <span className="h-2.5 w-2.5 rounded-full bg-[#1fff57]" />
                Tu tienda gamer de confianza
              </span>

              <div className="mt-6 space-y-5">
                <h1 className="text-[2.3rem] font-black uppercase leading-[0.9] tracking-[-0.04em] text-white sm:text-[3.5rem] lg:text-[4.8rem]">
                  Lo que tu mundo gamer <br />
                ...
                <p className="max-w-[50ch] text-[0.85rem] leading-[1.35] text-[rgba(223,232,255,0.9)] sm:text-[0.92rem] lg:text-[0.96rem]">
                  Gift cards, suscripciones, <span className="font-bold text-[#2dff63]">accesorios</span>,{' '}
                  <span className="font-bold text-[#ffd84a]">bases para consolas</span> y
                  productos impresos para llevar tu experiencia al siguiente nivel.
                </p>
              </div>
              ...
              <div className="mt-4 flex flex-col gap-2.5 sm:flex-row">
                <a
                  href="#catalog"
                  className="inline-flex h-11 items-center justify-center gap-2 rounded-2xl bg-[linear-gradient(135deg,#3f5dff_0%,#4b74ff_100%)] px-6 text-[0.8rem] font-black uppercase tracking-[-0.02em] text-white shadow-[0_18px_40px_rgba(64,103,255,0.3)] transition-transform duration-300 hover:-translate-y-0.5 lg:h-12 lg:text-[0.86rem]"
                >
                ...
                <a
                  href="#featured"
                  className="inline-flex h-11 items-center justify-center gap-2 rounded-2xl border border-[rgba(30,255,93,0.72)] bg-[rgba(4,11,31,0.64)] px-6 text-[0.8rem] font-black uppercase tracking-[-0.02em] text-white transition-colors duration-300 hover:bg-[rgba(7,21,53,0.82)] lg:h-12 lg:text-[0.86rem]"
                >
                  <Grid3X3 className="h-3.5 w-3.5 text-[#1fff57] lg:h-4 lg:w-4" />
                  Ver catalogo
                </a>
              </div>

              <div className="mt-10 grid max-w-[520px] gap-6 md:grid-cols-3">
      ...
      <div className="relative z-20 px-4 pb-12 sm:px-6 lg:px-10">
        <div className="mx-auto max-w-[1400px] rounded-[24px] border border-[rgba(71,111,204,0.12)] bg-[rgba(2,6,23,0.7)] p-1 shadow-[0_20px_50px_rgba(0,0,0,0.5)] backdrop-blur-xl">
          <div className="grid grid-cols-1 divide-y divide-[rgba(71,111,204,0.16)] sm:grid-cols-2 lg:grid-cols-5 lg:divide-x lg:divide-y-0">
